...
def calc_metrics(data: pd.DataFrame, 
                 y_true='y_true', 
                 y_pred='y_pred',
    ...
    df_metrics = pd.DataFrame({'recall': {'value':recall},
                               ...
                               'f1': {'value':f1},
                               'auc': {'value':auc},
                               'Cost': {'value':money_cost}}).style.format('{:.2f}')
...
def calc_cost(data: pd.DataFrame,
              y_true='y_true', 
              y_pred='y_pred')-> pd.Series:
    """_summary_
    ...
    costs_vector = data.apply(lambda x: cost(x,
                                             y_true=y_true,
